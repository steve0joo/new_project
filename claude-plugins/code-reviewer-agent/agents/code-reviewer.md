...
model: inherit
skills:
  - code-review-skill:comprehensive-code-review
---
...
1. **Load the methodology first.** Invoke the `code-review-skill:comprehensive-code-review` skill
   via the Skill tool before doing anything else (it ships in the companion `code-review-skill`
   plugin). It defines the three review lenses, the severity rubric, and the exact report format
   you must follow. Do not improvise your own structure — consistency across reviews is the point
   of this agent.
